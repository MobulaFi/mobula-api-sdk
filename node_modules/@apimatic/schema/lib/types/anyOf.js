...
function anyOf(schemas, discriminatorMap, discriminatorField) {
    if (discriminatorMap && discriminatorField) {
        return createAnyOfWithDiscriminator(schemas, discriminatorMap, discriminatorField);
    }
    else {
...
exports.anyOf = anyOf;
function createAnyOfWithDiscriminator(schemas, discriminatorMap, discriminatorField) {
    return {
...
function createAnyOfWithoutDiscriminator(schemas) {
    return {
        type: function () { return "OneOf<" + schemas.map(function (schema) { return schema.type(); }).join(' | ') + ">"; },
        validateBeforeMap: function (value, ctxt) {
            return matchAndValidateBeforeMap(schemas, value, ctxt);
